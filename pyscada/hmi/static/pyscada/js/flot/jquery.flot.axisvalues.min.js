                    ...
                    for (xaxis in xaxes) {
                        ...
                        if (typeof xaxes[xaxis].box !== 'undefined' && typeof xaxes[xaxis].box.padding !== 'undefined' && typeof xaxes[xaxis].box.top !== 'undefined' && typeof xaxes[xaxis].box.height !== 'undefined') {
                            ...
                            if (xaxes[xaxis].options.mode == "time") {
                                ...
                                x_value = xaxes[xaxis].c2p(drawX).toFixed(1);
                            }
                    ...
                    for (yaxis in yaxes) {
                        ...
                        if (typeof yaxes[yaxis].box !== 'undefined' && typeof yaxes[yaxis].box.padding !== 'undefined' && typeof yaxes[yaxis].box.left !== 'undefined' && typeof yaxes[yaxis].box.width !== 'undefined') {
                            if (yaxes[yaxis].position == "left") {
                                $("#y" + yaxisplusone + "-tooltip").html(yaxes[yaxis].c2p(drawY).toFixed(1))
                                    .css({top: offset.top + drawY - yaxes[yaxis].box.padding, left: offset.left - yaxes[yaxis].box.width})
                                    .show();
...
//                                    .css({top: offset.top + drawY - yaxes[yaxis].box.padding, left: offset.left + yaxes[yaxis].box.left + yaxes[yaxis].box.padding - yaxes[yaxis].box.width})
                                    .css({top: offset.top + drawY - yaxes[yaxis].box.padding, left: offset.left + yaxes[yaxis].box.left - yaxes[yaxis].box.width})
                                    .show();
                            }
                        }
                    }
