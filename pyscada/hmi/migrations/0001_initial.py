    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('chart_line_color', models.ForeignKey(on_delete=django.db.models.deletion.SET_NULL, default=0, to='hmi.Color', null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('page', models.ForeignKey(on_delete=django.db.models.deletion.SET_NULL, default=0, to='hmi.Page', null=True)),
            ],
            options={
                'ordering': ['row', 'col'],
            },
