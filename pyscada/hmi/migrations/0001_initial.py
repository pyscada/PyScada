    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('x_axis_label', models.CharField(default='', max_length=400, blank=True)),
                ('x_axis_ticks', models.PositiveSmallIntegerField(default=6)),
                ('y_axis_label', models.CharField(default='', max_length=400, blank=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(serialize=False, primary_key=True)),
                ('title', models.CharField(default='', max_length=400, blank=True)),
                ('row', models.PositiveSmallIntegerField(default=0, choices=[(0, '1. row'), (1, '2. row'), (2, '3. row'), (3, '4. row'), (4, '5. row'), (5, '6. row'), (6, '7. row'), (7, '8. row'), (8, '9. row'), (9, '10. row'), (10, '11. row'), (11, '12. row')])),
