...
class VISAVariable(models.Model):
    ...
    device_property = models.CharField(default='present_value',max_length=255,help_text='name of the Property the variable be assigned to')
    def __unicode__(self):
        return unicode(self.visa_variable.name)
...
class VISADevice(models.Model):
    ...
    def __unicode__(self):
        return unicode(self.visa_device.short_name)

class VISADeviceHandler(models.Model):
    name        = models.CharField(default='',max_length=255)
    handler_class = models.CharField(default='pyscada.visa.devices.HP3456A',max_length=255,help_text='a Base class to extend can be found at pyscada.visa.devices.GenericDevice')
