...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='event',
            name='action',
            field=models.PositiveSmallIntegerField(choices=[(0, 'just record'), (1, 'record and send mail only when event occurs'), (2, 'record and send mail'), (3, 'record, send mail and change variable')], default=0),
        ),
        migrations.AlterField(
            model_name='event',
            name='variable_limit',
