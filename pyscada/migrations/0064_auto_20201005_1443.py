...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='complexeventitem',
            name='validation',
            field=models.PositiveSmallIntegerField(choices=[(0, 'OR'), (1, 'AND'), (2, 'Custom')], default=0),
        ),
        migrations.AlterField(
            model_name='complexeventitemvariable',
            name='limit_low_type',
            field=models.PositiveSmallIntegerField(choices=[(0, 'limit < value'), (1, 'limit <= value')], default=0),
        ),
        migrations.AlterField(
            model_name='complexeventitemvariable',
