...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AlterField(
            ...
            name='variable',
            field=models.ForeignKey(default=1, to='pyscada.Variable'),
        ...
        migrations.AlterField(
            ...
            name='time',
            field=models.ForeignKey(default=1, to='pyscada.RecordedTime'),
            preserve_default=False,
        ),
        migrations.AlterField(
            model_name='recordeddataboolean',
        ...
        migrations.AlterField(
            model_name='recordeddatacache',
            name='variable',
            field=models.OneToOneField(default=1, to='pyscada.Variable'),
            preserve_default=False,
        ),
        migrations.AlterField(
        ...
        migrations.AlterField(
            ...
            name='event',
            field=models.ForeignKey(default=1, to='pyscada.Event'),
            preserve_default=False,
        ),
        migrations.AlterField(
            model_name='recordedevent',
        ...
        migrations.AlterField(
            model_name='variable',
            name='client',
            field=models.ForeignKey(default=1, to='pyscada.Client'),
            preserve_default=False,
        ),
        migrations.AlterField(
            model_name='variable',
