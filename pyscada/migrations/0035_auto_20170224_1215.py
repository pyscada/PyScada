    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('protocol', models.CharField(default=b'generic', max_length=400)),
                ('description', models.TextField(default=b'', null=True, verbose_name=b'Description')),
                ('app_name', models.CharField(default=b'pyscada.PROTOCOL', max_length=400)),
                ('device_class', models.CharField(default=b'pyscada.PROTOCOL.device', max_length=400)),
